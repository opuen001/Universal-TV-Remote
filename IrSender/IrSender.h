...
class IrSender{
    ...
    const std::string files[16] = {"../rawTimings/vizioTimings.csv", "../rawTimings/aocTimings.csv", "../rawTimings/aristonaTimings.csv", 
        ...
        "../rawTimings/philipsTimings.csv", "../rawTimings/pioneerTimings.csv"};
