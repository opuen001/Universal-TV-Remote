...
class IrSender{
    ...
    const std::string files[26] = {"../rawTimings/vizioTimings.csv", "../rawTimings/aocTimings.csv", "../rawTimings/aristonaTimings.csv", 
        ...
        "../rawTimings/sonyTimings.csv", "../rawTimings/toshibaTimings.csv", "../rawTimings/vestelTimings.csv", "../rawTimings/westinghouseTimings.csv",
        "../rawTimings/zenithTimings.csv"};
