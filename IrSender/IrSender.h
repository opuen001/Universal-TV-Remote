...
class IrSender{
    ...
    const std::string files[19] = {"../rawTimings/vizioTimings.csv", "../rawTimings/aocTimings.csv", "../rawTimings/aristonaTimings.csv", 
        ...
        "../rawTimings/rcaTimings.csv", "../rawTimings/samsungTimings.csv"};
