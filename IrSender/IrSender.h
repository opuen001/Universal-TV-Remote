...
class IrSender{
    ...
    const std::string files[13] = {"../rawTimings/vizioTimings.csv", "../rawTimings/aocTimings.csv", "../rawTimings/aristonaTimings.csv", 
        ...
        "../rawTimings/magnavoxTimings.csv", "../rawTimings/mitsubishiTimings.csv"};
